...
mkdir -p /etc/docker/certs.d/$hostname:5101
cp ./nginx/ssl/registry-ca+ca.pem /etc/docker/certs.d/$hostname:5101/ca.crt

mkdir -p /etc/docker/certs.d/$hostname:5102
cp ./nginx/ssl/registry-ca+ca.pem /etc/docker/certs.d/$hostname:5102/ca.crt
